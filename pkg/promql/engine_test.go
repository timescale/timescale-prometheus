...
func (q *errSamplesQuerier) Select(bool, *storage.SelectHints, []parser.Node, ...*labels.Matcher) (storage.SeriesSet, parser.Node) {
...
func (h *hintRecordingQuerier) Select(sortSeries bool, hints *storage.SelectHints, p []parser.Node, matchers ...*labels.Matcher) (storage.SeriesSet, parser.Node) {
	...
	return h.SamplesQuerier.Select(sortSeries, hints, nil, matchers...)
}
